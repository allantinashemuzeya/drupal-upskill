        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Template(
                    '/Users/amuzeya/Developer/General/Traininig/testing/upskill_bro/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl',
                );
            } else {
                $template = new Template(
                    '/Users/amuzeya/Developer/General/Traininig/testing/upskill_bro/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl',
                );
            }
